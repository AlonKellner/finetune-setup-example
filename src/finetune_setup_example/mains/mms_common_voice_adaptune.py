...
def main(
    ...
    pretrained_wait_ratio: float = 0.2,
    pretrained_warmup_ratio: float = 0.3,
    pretrained_stable_ratio: float = 0.0,
    pretrained_decay_ratio: float = 0.4,
    ...
    adapter_stable_ratio: float = 0.0,
    adapter_decay_ratio: float = 0.9,
