...
def main(
    ...
    pretrained_stable_ratio: float = 0.1,
    pretrained_decay_ratio: float = 0.7,
    adapter_learning_rate: float = 1e-2,
    adapter_min_lr_ratio: float = 1e-3,
    adapter_wait_ratio: float = 0.0,
    adapter_warmup_ratio: float = 0.01,
    adapter_stable_ratio: float = 0.29,
    adapter_decay_ratio: float = 0.70,
