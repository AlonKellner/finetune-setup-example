...
def main(
    ...
    general_name: str = "all-common-voice",
    ...
    per_device_train_batch_total_seconds: float = 120.0,
    per_device_eval_batch_total_seconds: float = 120.0,
    num_devices: int = 1,
    pretrained_learning_rate: float = 1e-5,
    pretrained_min_lr_ratio: float = 0.0,
    pretrained_wait_ratio: float = 0.05,
    pretrained_warmup_ratio: float = 0.05,
    ...
    eval_sync_all_on_start: bool = False,
    complete_initial_files: bool = False,
